...
export class Logger {
     ...
     * @param {boolean} verbose Whether to log to console as well as to the file.
     */
    public constructor(fileName: string, behaviour: DuplicateLogBehaviour, verbose: boolean) {
